  ...
  return (
    <div className="lp-root">
      ...
      <div className="lp-trust-bar">
        <span>✓ HPCSA Registered — DR 0092673</span>
      ...
      <style>{`
        ...
        .lp-logo { width: 38px; height: 38px; border-radius: 10px; object-fit: cover; }
        .lp-brand-name { font-weight: 700; font-size: 15px; color: #0a1628; letter-spacing: -0.02em; }
        .lp-links { display: flex; gap: 28px; }
        .lp-links a { text-decoration: none; color: #3a5575; font-size: 14px; font-weight: 500; transition: color 0.15s; }
        ...
        .lp-hero-inner { max-width: 1100px; margin: 0 auto; width: 100%; position: relative; z-index: 2; }
        .lp-eyebrow { font-size: 13px; font-weight: 600; letter-spacing: 0.12em; text-transform: uppercase; color: #2d9cdb; margin-bottom: 18px; }
        .lp-h1 { font-size: clamp(2.4rem, 5vw, 3.8rem); font-weight: 800; line-height: 1.08; color: #ffffff; letter-spacing: -0.03em; margin-bottom: 22px; }
        .lp-h1 em { font-style: normal; color: #2d9cdb; }
        .lp-subhead { font-size: 1.05rem; color: rgba(255,255,255,0.72); line-height: 1.65; max-width: 520px; margin-bottom: 36px; }
        ...
        .lp-btn-primary:hover { background: #1e8bc3; transform: translateY(-1px); }
        .lp-btn-ghost {
          display: inline-block;
        ...
        .lp-hero-logo-bg { width: 140px; height: 140px; border-radius: 32px; object-fit: cover; opacity: 0.22; position: absolute; }
        @media(max-width: 768px) { .lp-hero-accent { display: none; } }
        .lp-trust-bar {
          background: #0a1628;
        ...
        .lp-services { padding: 96px 24px; background: #f8fafd; }
        .lp-section-inner { max-width: 1100px; margin: 0 auto; }
        .lp-section-eyebrow { font-size: 12px; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: #2d9cdb; margin-bottom: 10px; }
        .lp-h2 { font-size: clamp(1.7rem, 3vw, 2.4rem); font-weight: 800; letter-spacing: -0.03em; color: #0a1628; margin-bottom: 48px; }
        .lp-scan-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 20px; margin-bottom: 48px; }
        .lp-scan-card { background: #fff; border: 1px solid rgba(30,58,95,0.08); border-radius: 16px; padding: 28px; transition: box-shadow 0.2s, transform 0.15s; }
        .lp-scan-card:hover { box-shadow: 0 8px 32px rgba(10,22,40,0.10); transform: translateY(-2px); }
        .lp-scan-icon { font-size: 26px; display: block; margin-bottom: 14px; }
        .lp-scan-card h3 { font-size: 16px; font-weight: 700; color: #0a1628; margin-bottom: 8px; }
        .lp-scan-card p { font-size: 13.5px; color: #5a7290; line-height: 1.55; }
        .lp-book-cta { text-align: center; }
        .lp-about { background: linear-gradient(160deg, #0a1628 0%, #1e3a5f 100%); padding: 96px 24px; }
        .lp-about-inner { display: grid; grid-template-columns: 1fr auto; gap: 64px; align-items: center; }
        @media(max-width: 700px) { .lp-about-inner { grid-template-columns: 1fr; } }
        .lp-about .lp-section-eyebrow { color: #2d9cdb; }
        .lp-about .lp-h2 { color: #fff; }
        .lp-body { font-size: 15px; color: rgba(255,255,255,0.72); line-height: 1.7; margin-bottom: 16px; }
        .lp-credential { font-size: 13px; color: rgba(255,255,255,0.45); font-weight: 500; letter-spacing: 0.04em; margin-top: 24px; }
        .lp-about-badge { display: flex; flex-direction: column; align-items: center; gap: 14px; }
        .lp-about-logo { width: 120px; height: 120px; border-radius: 26px; object-fit: cover; opacity: 0.85; border: 2px solid rgba(45,156,219,0.3); }
        .lp-about-tagline { font-size: 12px; font-weight: 600; letter-spacing: 0.1em; color: rgba(255,255,255,0.4); text-transform: uppercase; }
        .lp-contact { padding: 96px 24px; background: #f8fafd; }
        .lp-contact-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap: 20px; }
        .lp-contact-card { background: #fff; border: 1px solid rgba(30,58,95,0.08); border-radius: 16px; padding: 28px; }
        .lp-contact-card--wa { border-color: rgba(45,156,219,0.25); background: #eef7fd; }
        .lp-contact-icon { font-size: 24px; display: block; margin-bottom: 14px; }
        .lp-contact-card h3 { font-size: 13px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.08em; color: #5a7290; margin-bottom: 10px; }
        .lp-contact-card p { font-size: 14.5px; color: #0a1628; line-height: 1.65; }
        .lp-contact-card a { color: #2d9cdb; text-decoration: none; }
        .lp-contact-card a:hover { text-decoration: underline; }
        .lp-btn-sm { padding: 10px 18px; font-size: 14px; }
        .lp-footer { background: #0a1628; padding: 32px 24px; border-top: 1px solid rgba(255,255,255,0.06); }
        ...
        .lp-footer-brand { display: flex; align-items: center; gap: 10px; color: rgba(255,255,255,0.7); font-size: 14px; font-weight: 600; }
        .lp-footer-logo { width: 28px; height: 28px; border-radius: 7px; object-fit: cover; opacity: 0.7; }
        .lp-footer-copy { font-size: 12px; color: rgba(255,255,255,0.35); }
        .lp-staff-link { background: none; border: none; color: rgba(255,255,255,0.2); font-size: 12px; cursor: pointer; padding: 4px 8px; border-radius: 4px; transition: color 0.15s, background 0.15s; }
        .lp-staff-link:hover { color: rgba(255,255,255,0.5); background: rgba(255,255,255,0.06); }
      `}</style>
    </div>
  );
}
